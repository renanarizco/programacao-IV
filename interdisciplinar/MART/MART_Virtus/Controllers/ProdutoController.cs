...
namespace MART_Virtus.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("produto_descricao,produto_marca,produto_codbarras,produto_precocusto,produto_precovenda,produto_estoque")] Produto produto)
        {
